...
```shell
go get -u github.com/xiaohuasheng0x1/blockchains/coins/kaspa
```
...
## License
Most packages or folder are [MIT](<https://github.com/xiaohuasheng0x1/blockchains/blob/main/coins/kaspa/LICENSE>) licensed, see package or folder for the respective license.

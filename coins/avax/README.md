...
```shell
go get -u github.com/xiaohuasheng0x1/blockchains/coins/avax
```
...
## License
Most packages or folder are [MIT](<https://github.com/xiaohuasheng0x1/blockchains/blob/main/coins/avax/LICENSE>) licensed, see package or folder for the respective license.

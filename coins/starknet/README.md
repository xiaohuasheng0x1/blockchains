...
```shell
go get -u github.com/xiaohuasheng0x1/blockchains/coins/starknet
```
...
## License
Most packages or folder are [MIT](<https://github.com/xiaohuasheng0x1/blockchains/blob/main/coins/starknet/LICENSE>) licensed, see package or folder for the respective license.
